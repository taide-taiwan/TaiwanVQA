...
@inproceedings{taiwanvqa2024,
  title={TaiwanVQA: A Visual Question Answering Benchmark for Taiwanese Daily Life},
  author={Hsieh, Hsin Yi and Liu, Shang Wei and Meng, Chang Chih and Chen, Chien Hwa and Lin, Shuo Yue and Huang, Hen-Hsen},
  booktitle={COLING 2024 (to appear)},
  year={2024}
}